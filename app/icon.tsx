...
// Image generation - creates a medical feeding bag icon using SVG
export default function Icon() {
  return new ImageResponse(
    ...
    >
      {/* Medical feeding bag SVG */}
      <svg width="432" height="432" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
        {/* Feeding bag body */}
